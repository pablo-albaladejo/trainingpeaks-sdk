/**
 * Semantic Release Configuration Generator
 * Generates release config with dynamic branch names and project information
 */
...
module.exports = {
  branches: [
    ...
    {
      name: '${config.ci.branches.develop}',
      prerelease: 'beta',
    },
    {
      name: '${config.ci.branches.alpha}',
      prerelease: true,
    },
  ],
  plugins: [
